...
void main() {
  ...
  group('get tv detail', () {
    ...
    test('should return tv detail when the response code is 200', () async {
      // arrange
      when(mockIOClient.get(Uri.parse('$BASE_URL/tv/$Id?$API_KEY'))).thenAnswer(
          (_) async =>
  ...
  group('get tv recommendations', () {
    final ttvlist =
        TvResponse.fromJson(json.decode(readJson('dummy_data/tv_recomd.json')))
            .tvlist;
    final Id = 1;
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockIOClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tv_recomd.json'), 200));
      // act
  ...
  group('search tv', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(readJson('dummy_data/search_doremon.json')))
        .tvlist;
    ...
    test('should return list of tvs when response code is 200', () async {
      ...
      when(mockIOClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/search_doremon.json'), 200));
      // act
